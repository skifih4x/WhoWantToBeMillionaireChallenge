...
struct QuestionManager {
   static let question = [
        ...
        QuestionMain(q: "Как звали Колумба?",
        ...
        QuestionMain(q: "Назовите столицу Суринама?",
        ...
        QuestionMain(q: "В какой из этих игр используется мяч наибольшей величины?",
        ...
        QuestionMain(q: "Какое из этих красных грузинских вин - полусладкое?",
        ...
        QuestionMain(q: "В каком штате США расположен город Солт-Лейк-Сити - столица Зимней Олимпиады 2002 года?",
        ...
        QuestionMain(q: "Какая олимпийская дистанция плавания самая длинная?",
                          a: [(answer: "800 м", isCorrect: false),
                              (answer: "1000 м", isCorrect: false),
                              (answer: "1500 м", isCorrect: true),
                              (answer: "3000 м", isCorrect: false)
                             ], l: 3),
        QuestionMain(q: "Как называется певучее исполнение на музыкальных инструментах (подражание пению)?",
        ...
        QuestionMain(q: "Гражданином какой страны был открыватель пенициллина Александр Флеминг?",
        ...
        QuestionMain(q: "Как в старину на флоте называли горячий чай с лимоном, сдобренный значительной порцией рома?",
                          a: [(answer: "Адвокат", isCorrect: true),
                              (answer: "Батя", isCorrect: false),
                              (answer: "Атаман", isCorrect: false),
                              (answer: "Браток", isCorrect: false)
                             ], l: 1),
        QuestionMain(q: "Какой из этих российских орденов был младше остальных?",
        ...
        QuestionMain(q: "Что из этого является изюмом с косточками?",
                          a: [(answer: "Сабза", isCorrect: false),
                              (answer: "Кайса", isCorrect: false),
                              (answer: "Вассарга", isCorrect: true),
                              (answer: "Сарга", isCorrect: false)
                             ], l: 3),
        QuestionMain(q: "Какой сигнал на российских морских пляжах означает запрет на купание?",
